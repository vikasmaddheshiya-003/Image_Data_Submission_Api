Publish Cheque Submission through undertow rest API with data model given below 
curl -X POST \
  https://192.168.2.212:8547/expressClear_API/apis/cheque_submission/ \
  -H 'Content-Type: text/plain' \
  -H 'clientIP: 192.168.2.154' \
  -d '{
"cheque-processing": 
{
"actionType": "ADD",
...
"draweeAccountNumber": "4434563431",
"creditAccountNumber": "2134565432456",
"presentmentDate": "1560954707212",
"settlementDate": "1560954707212",
"chequeDate": "1560954707212",
"type": "CLG",
"amount": "12234.23",
"punchedAmount": "12234.23",
"beneficiaryEntity": "EIB",
"depositMachineId": "E0000001",
"postingRequired": "YES",
"corporateId": "1234567895",
"corporateName": "AAA",
"postingTransactionId": "11323123hjgjj",
"image": {
...
"utility": {
"type": "JAFZA",
"referenceNumber": "123231238956123456789",
"consumerNumber": "45546567894561234568"
},
"collateral": {
"loanAccountNumber": "1234567895",
"originationId": "132132112",
"agreementId": "13221ij",
"installmentNumber": "1333555"
},
"narrations": [
"1223132131221",
"1223132131221",
...
Note : 
1. When received a request do proper validation 
2. Insert in tbl_outward (actionType, chequeNumber, front, rear)
3. front and rear first decode base64 and convert in byte[] then insert in db as blob

Validation:
HTTP Description  -  HTTP code
OK   -             200
PARTIAL_CONTENT  - 206
BAD_REQUEST  - 400
...
chequeNumber - 6 digit,fixed – String (Varchar)
routingNumber - 9 digit, fixed - String (Varchar)
draweeAcount - 10 digit,fixed - String (Varchar)
creditAccountNumber - 16 digit max - String (Varchar)
presentmentDate – Unix Timestamp - as presentmentDate does not have time, it shall be the representation of the exact date
settlementDate – Unix Timestamp - as settlementDate does not have time, it shall be the representation of the exact date
chequeDate - Unix Timestamp - as chequeDate does not have time, it shall be the representation of the exact date
type - 10 digit - String(Varchar)
amount - 8+2 digits - String (Varchar)
punchedAmount -  8+2 digits - String (Varchar)
depositMachineId - 16 digit - String(Varchar)
postingRequired - TRUE/FALSE - String (Varchar)
corporateID - 10 digit - String(Varchar)
corporateName - 50 digit - String(Varchar)
postingTransactionId - 20 digit - String(Varchar)
referenceNum - 21 digit unique number - String (Varchar)
consumerNumber - 20 digit - String(Varchar)

narrations: 
string1 –- 50 characters, alphanumeric - String (Varchar)
string2 - 50 characters, alphanumeric - String (Varchar)
string3 - 50 characters, alphanumeric - String (Varchar)
loanAccountNumber - 16 digit - String(Varchar)
originationId - 20 digit - String(Varchar)
agreementId - 20 digit - String(Varchar)
installmentNumber - 20 digit - String(Varchar)
